...
def main():
    ...
    parser.add_argument('--dataroot', type=str, default='A:/Users/SSY/Desktop/dataset/image_calibration/0702 data set')
    ...
    Digo.init(api_key="qpqD6cHYvGG2XNHeGlHog8360T8uWHya", workspace_name='Yunsang', project_name='Sunyong Project')
